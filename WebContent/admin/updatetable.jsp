            ...
            <nav class="navbar-default navbar-side" role="navigation">
                <div class="sidebar-collapse">
                    <ul class="nav" id="main-menu">
                        ...
                        <li>
                            <a class="active-menu" href="TableServlet?update=1"><i class="fa fa-edit"></i>Update</a>
                        </li>
                        <li>
					                        ...
					                        <table class="table">
					                            ...
					                            %>
					                            			<tr>
															    ...
															    <td><input type="text" class="user" name="typetable" value=<%=tables.get(i).getId()%> readonly></td>
															    <td><input type="text" class="user" name="pricetable" value=<%=tables.get(i).getPrice()%>></td>
															    <td><%=tables.get(i).getBooked()%></td>
															    <td><input type="submit" class ='btn btn-primary' name="updateTable" value="Update"></td>
															    </form>
															</tr>
                                    			<%
	                                                	}
